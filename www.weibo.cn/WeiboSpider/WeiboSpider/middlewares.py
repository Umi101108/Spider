...
class CookiesMiddleWare(object):
    ...
    def trans_cookie(self):
        cookies = '_T_WM=62eda214392f0618f0336346688098e1; SCF=AvwzagndiVhyirA4jY0sUyhXy-MvVy1I4w5ONswfyeMIyRfcqhqztNeYJNlMgBIRq89auZKvbyan-p9nGudzKC4.; TMPTOKEN=gPQFmY1dMFRosvESoCnMSHfIMooOqDqAquIRQlUzSSapSoIzhWPNtHvONrifYO1Q; SUB=_2A253_F0yDeRhGedJ7FER8CjIwj6IHXVVH2N6rDV6PUJbkdB-LXaikW1NUbuWFET7hf1nfNkuffFohTZnay11mulj; SUHB=0ebsv81LVJMUZw; SSOLoginState=1526213986'
        return {k.split('=')[0].strip(): k.split('=')[1].strip() for k in cookies.split(';')}
