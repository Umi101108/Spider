...
class DrugItem(scrapy.Item):
	...
	def get_insert_sql(self):
		insert_sql = """
				INSERT INTO bc_product_directiondb_copy(commonname, tradename, warningsmarks, ingredients, characters, radioactivityandtime, actioncategory, indications, specification, dosageandadministration, adversereactions, contraindications, warning, cautions, pregnancyandnursingmothers, pediatricuse, geriatricuse, list_interaction, overdosage, clinicaltrails, pharmacologicalandtoxicological, pharmacokinetics, storage, package, usefullife, implementstandard, approvalno, registerno, importlicenceno, corporationname)
				VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
				"""
		params = (
			self["commonname"], self["tradename"], self["warningsmarks"], self["ingredients"], self["characters"], self["radioactivityandtime"], self["actioncategory"], self["indications"], self["specification"], self["dosageandadministration"], self["adversereactions"], self["contraindications"], self["warning"], self["cautions"], self["pregnancyandnursingmothers"], self["pediatricuse"], self["geriatricuse"], self["list_interaction"], self["overdosage"], self["clinicaltrails"], self["pharmacologicalandtoxicological"], self["pharmacokinetics"], self["storage"], self["package"], self["usefullife"], self["implementstandard"], self["approvalno"], self["registerno"], self["importlicenceno"], self["corporationname"],
		)
